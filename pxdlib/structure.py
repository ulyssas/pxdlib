...
from .helpers import hexbyte, num
...
class RGBA:
    ...
    def _to_data(self):
        r, g, b, a = list(self)
        return [1, {"m": 2, "csr": 0, "c": [r / 255, g / 255, b / 255, a / 255]}]
...
class Gradient:
    ...
    _default_cols = [(RGBA("48a0f8"), 0), (RGBA("48a0f800"), 1)]
    ...
    def _from_data(cls, data):
        ...
        colors = [
            (RGBA(r * 255, g * 255, b * 255, a * 255), x) for (r, g, b, a), x in colors
        ]
