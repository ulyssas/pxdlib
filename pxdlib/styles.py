...
from .enums import BlendMode, FillType, StrokePosition, StrokeType
...
class Style:
    ...
    def __repr__(self):
        args = ", ".join(
            [
                ...
                if k in _STYLE_TAGS and self._dict[k] != self._defaults[k]
            ]
        )
    ...
    def _from_layer(cls, data):
        ...
        if "gSP" in self._dict:
            self._dict["_gPos"] = (self._dict.pop("gSP"), self._dict.pop("gEP"))
        return self
        ...
        1,
        {
            ...
            "s": [
                ...
                [
                    1,
                    [
                        [0.3254901960784314, 0.7137254901960784, 0.9764705882352941, 1],
                        1,
                    ],
                ],
            ],
